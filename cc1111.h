...
__xdata __at (0xde00)
volatile uint8_t USBADDR;

__xdata __at (0xde01)
volatile uint8_t USBPOW;

__xdata __at (0xde02)
volatile uint8_t USBIIF;

__xdata __at (0xde04)
volatile uint8_t USBOIF;

__xdata __at (0xde06)
volatile uint8_t USBCIF;
...
__xdata __at (0xde07)
volatile uint8_t USBIIE;

__xdata __at (0xde09)
volatile uint8_t USBOIE;

__xdata __at (0xde0b)
volatile uint8_t USBCIE;
...
__xdata __at (0xde13)
volatile uint8_t USBMAXO;

__xdata __at (0xde14)
volatile uint8_t USBCSOL;
...
__xdata __at (0xde16)
volatile uint8_t USBCNT0;

__xdata __at (0xde16)
volatile uint8_t USBCNTL;
...
#define ADCCON3_EDIV_MASK          (3 << 4)   /* Extra decimation */
...
__xdata __at (0xDFC1)
volatile uint8_t U0DBUFXADDR;

__sfr __at 0xf9 U1DBUF;
__xdata __at (0xDFF9)
volatile uint8_t U1DBUFXADDR;
...
__xdata __at (0xDFB1)
volatile uint8_t ENCDIXADDR;

__xdata __at (0xDFB2)
volatile uint8_t ENCDOXADDR;
